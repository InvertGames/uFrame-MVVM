...
public class UBOnCollisionExit2DTrigger : UBTrigger
{
    public static IEnumerable<IUBVariableDeclare> UBOnCollisionExit2DTriggerVariables()
    {
    ...
    public static void OnCollisionExit2D(IUBCSharpGenerator generator, TriggerInfo data)
    {
