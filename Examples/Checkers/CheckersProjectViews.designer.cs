...
public abstract class CheckersGameViewBase : ViewBase {
    ...
    [UFGroup("View Model Properties")]
    [UnityEngine.HideInInspector()]
    public Int32 _BlackScore;
    
    [UFGroup("View Model Properties")]
    [UnityEngine.HideInInspector()]
    public Int32 _RedScore;
...
public class CheckerPlateViewViewBase : CheckerPlateViewBase {
    ...
    public virtual void CanMoveToChanged(Boolean value) {
    }
    
    public virtual void PositionChanged(Vector2 value) {
    }
    
    public virtual void IsEvenChanged(Boolean value) {
    }
...
public class CheckerViewViewBase : CheckerViewBase {
    ...
    public virtual void IsKingMeChanged(Boolean value) {
    }
...
public class CheckersGameViewViewBase : CheckersGameViewBase {
    ...
    public virtual void BlackScoreChanged(Int32 value) {
    }
    
    public virtual void RedScoreChanged(Int32 value) {
    }
...
public class AICheckersViewViewBase : CheckersGameView {
    ...
    protected override void Apply() {
        base.Apply();
        if (AICheckersGame.Dirty) {
            AICheckersGame.Dirty = false;
        }
    }
}
