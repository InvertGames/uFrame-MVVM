...
public class PlaymakerPlugin : DiagramPlugin {
    public override void Initialize(uFrameContainer container)
    {
        ...
        container.Register<NodeItemGenerator, PlaymakerElementNodeGenerator>("SamplePluginCodeGenerator");
        //uFrameEditor.HookCommand<IDiagramContextCommand>("SampleMessage", command);
    }
}

public class PlaymakerElementNodeGenerator : NodeItemGenerator<ElementData>
{
...
public class PlaymakerActionCodeGenerator : CodeGenerator
{
    ...
    public override void Initialize(CodeFileGenerator fileGenerator)
    {
        ...
        {
            Name = CommandData.Name + (IsDesignerFile ? "PlaymakerActionBase" : "PlaymakerAction"),
            Attributes = MemberAttributes.Public
        };

        classDecleration.BaseTypes.Add(new CodeTypeReference(IsDesignerFile ? "FsmStateAction" : CommandData.Name + "PlaymakerActionBase"));
