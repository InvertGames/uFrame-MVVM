...
[UBCategory("Physics")]
public class CheckCapsuleByStartEndRadiusAndLayermask : UBConditionAction {
...
return Physics.CheckCapsule(_Start.GetValue(context),_End.GetValue(context),_Radius.GetValue(context),_Layermask.GetValue(context))		;

	}

	public override string WriteExpressionCode(IUBCSharpGenerator sb){
		return sb.Expression("Physics.CheckCapsule(#_Start#, #_End#, #_Radius#, #_Layermask#)");
	}
