...
public class GetGameObjectHingeJoint : UBAction {
	...
	protected override void PerformExecute(IUBContext context){
		if (_Result != null){
			_Result.SetValue( context, _GameObject.GetValue(context).hingeJoint);
		}

	}

	public override string ToString(){
	return string.Format("Get hingeJoint from {0}", _GameObject.ToString(RootContainer));
	}

	public override void WriteCode(IUBCSharpGenerator sb){
		sb.AppendExpression("#_Result# = #_GameObject#.hingeJoint");
	}
