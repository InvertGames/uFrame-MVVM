...
public class SceneBSceneManager : SceneManager
{
    public override IEnumerator Load(UpdateProgressDelegate progress)
    {
        progress("Scene B Controller - Step 1", 0.2f);
        yield return new WaitForSeconds(1f);
        progress("Scene B Controller - Step 2", 0.4f);
        yield return new WaitForSeconds(1f);
        progress("Scene B Controller - Step 3", 0.6f);
        yield return new WaitForSeconds(1f);
        progress("Scene B Controller - Step 4", 0.8f);
        yield return new WaitForSeconds(1f);
        progress("Scene B Controller - Step 5", 1f);
    }
